  ...
  describe('User List', function(done) {
    ...
    it('should respond with a JSON Object with Users as an Array', function(done) {
      userService.list({pageSize: 5, pageIndex: 0}, function(err, result) {
        ...
        //result.data.users.should.have.length(1);
       // user = result.users[0];
        done();
      });
    });
    it('Defines a Property Id');
    it('Defines a Property Email');
    it('Defines a Property UserName');
    it('Defines a Property FirstName');
    it('Defines a Property LastName');
